...
//        echo "\n this->table before join logic ".$this->table."\n\n" ;
		// Case where joining the same table
		if($this->table == $table) {
//            echo "joining the same table\n";
			$oldTable = $this->table;
...
//            echo "\n this->table in join logic ".$this->table."\n\n" ;
		...
		foreach($this->joins as $join) {
			if($join == $newJoin) {
//                echo "\n this->table in join logic 2 ".$this->table."\n\n" ;
...
//                echo "\n this->table in join logic 3 ".$this->table."\n\n" ;
...
//        echo "\n this->table in join logic 4 ".$this->table."\n\n" ;
